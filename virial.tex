...
ここでビリアル定理を銀河内の物質に対して式\eqref{eq:virial}の
\begin{equation}
...
近傍の宇宙の場合，ビリアル半径は$R_{180}$や$R_{200}$程度であると考えることができ，より遠方の宇宙では宇宙項が無視できないため，$R_{100}$や$R_{110}$がビリアル半径となる．本研究では近傍宇宙，赤方偏移$z=0.00$を解析するため式\eqref{eq:r200}を用いる．
